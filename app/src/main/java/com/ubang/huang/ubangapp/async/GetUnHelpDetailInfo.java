...
public class GetUnHelpDetailInfo extends AsyncTask<String, Void, String> {
    private int help_id;
    private Handler handler;
    public GetUnHelpDetailInfo(Handler handler, int help_id){
                ...
                .execute(new Callback() {
                    ...
                    public Object parseNetworkResponse(Response response, int id) throws Exception {
                        ...
                        try {
                            ...
                            message.what = Signal.GetUnHelpDetailInfo;
