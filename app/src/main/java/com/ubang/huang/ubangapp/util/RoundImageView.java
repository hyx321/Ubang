...
import android.util.TypedValue;;import com.ubang.huang.ubangapp.R;
...
public class RoundImageView extends AppCompatImageView {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        currMode = a.hasValue(R.styleable.RoundImageView_style) ? a.getInt(R.styleable.RoundImageView_style, MODE_NONE) : MODE_NONE;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawMatrix == null && getPaddingTop() == 0 && getPaddingLeft() == 0) {
            ...
            if (currMode == MODE_CIRCLE) {
                ...
                mPaint.setShader(getShader(bitmap));
    ...
    private Shader getShader(Bitmap bitmap){
