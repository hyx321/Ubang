...
public class GetHelpingDetailInfo extends AsyncTask<String, Void, String> {
    private int help_id;
    private Handler handler;
    public GetHelpingDetailInfo(Handler handler, int help_id){
                ...
                .execute(new Callback() {
                    ...
                    public Object parseNetworkResponse(Response response, int id) throws Exception {
                        ...
                        try {
                            ...
                            message.what = Signal.GetHelpingDetailInfo;
