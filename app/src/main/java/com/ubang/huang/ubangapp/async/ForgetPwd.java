...
public class ForgetPwd extends AsyncTask<String, Void, String> {
    private Handler handler;
    private Message message;
    private User user;

    public ForgetPwd(Handler handler, User user){
        ...
        OkHttpUtils
                ...
                .execute(new Callback() {
                    ...
                    public Object parseNetworkResponse(Response response, int id) throws Exception {
                        ...
                        if("1".equals(string)){
                            message = new Message();
                            message.what = Signal.Modefy_Suc;
                            handler.sendMessage(message);
                        }else{
                            message = new Message();
                            message.what = Signal.Modefy_Fail;
                            handler.sendMessage(message);
                        }
                        return null;
                    }
