...
public class Help {
    ...
    public List<String> getHelp_url() {
        return help_url;
    }

    public void setHelp_url(List<String> help_url) {
    ...
    public void setHelp_startPostion(String help_startPosition) {
    ...
    public String getAccert_Postion() {
        return accert_position;
    }

    public void setAccert_Postion(String accert_postion) {
        this.accert_position = accert_postion;
    }
    ...
    public String toString() {
        return "{\"help_content\":\"" + help_content + "\", \"help_taskId\":\"" + help_taskId + "\", \"help_phone\":\""
                ...
                + help_status + "\", \"accept_phone\":\"" + accept_phone + "\", \"accert_postion\":\"" + accert_position
                + "\", \"isNormal\":\"" + isNormal + "\"}";
    }
}
